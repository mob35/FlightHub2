 ...
 */
angular.module("inflightHubApp").controller("NestedListsDemoController", function($scope, setupCartService, $filter, $routeParams) {
    ...
    $scope.food = $filter("filter")($scope.models.templates, { cate: "Food" });
    $scope.drink = $filter("filter")($scope.models.templates, { cate: "Drink" });
    $scope.fast = $filter("filter")($scope.models.templates, { cate: "Fast" });
    $scope.dessert = $filter("filter")($scope.models.templates, { cate: "Dessert" });
    $scope.combo = $filter("filter")($scope.models.templates, { cate: "Combo" });
